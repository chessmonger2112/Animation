...
var enemyPicRight = "enemy_right.bmp";
var enemyPicLeft = "enemy_left.bmp";
var boom = "boom.jpg";
var dead = "dead_left.jpg";
var spikes = "spikes.bmp";
var coin = "coin.jpg";
var Tree = "tree.bmp";
var Dock = "dock.bmp";
var Ocean = "ocean.jpg";
var Duck = "duck_boat.jpg";
...
var TAU = 2*PI;
var treeTheta = 0;
var tree = {x:300,y:150,w:200,h:400};
var treeCenter = {x:tree.x,y:tree.y};
var dock = {x:canvas.width-300,y:canvas.height-150,w:300,h:150};
var ocean = {x:0,y:canvas.height-120,w:canvas.width-dock.w,h:120};
var duck = {x:dock.x-400,y:ocean.y-120,w:300,h:150};
...
var map4 = [{x:0,y:0},{x:dock.x-1,y:0},{x:dock.x,y:299},{x:dock.x+10,y:300},{x:canvas.width,y:150}];

var height = [map1,map2,map3,map4];
...
var IronMonger = function() {
    ...
    function uphill()
    {
     ...
     //console.log("we got to dx dy land");
     console.log(dyPrime);
    }
